...
import (
	crdcontroller_v1alpha1 "github.com/Emruz-Hossain/kubernetes-practice/crd-controller/pkg/apis/crdcontroller/v1alpha1"
	...
	v1alpha1 "github.com/Emruz-Hossain/kubernetes-practice/crd-controller/pkg/client/listers/crdcontroller/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CrdexampleV1alpha1().CustomDeployments(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CrdexampleV1alpha1().CustomDeployments(namespace).Watch(options)
			},
		},
		&crdcontroller_v1alpha1.CustomDeployment{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *customDeploymentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&crdcontroller_v1alpha1.CustomDeployment{}, f.defaultInformer)
}
